ESP32 Soil Moisture Sensor with Auto-Calibration: 
    A simple Arduino sketch for ESP32 that reads soil moisture levels with automatic calibration feature. This code helps you measure soil moisture percentage and automatically calibrates the sensor for dry and wet conditions.

Project Description:
    This project uses an ESP32 microcontroller and a soil moisture sensor to measure soil moisture levels. The code includes an auto-calibration routine that guides the user through dry and wet calibration steps for accurate moisture percentage calculations.
